  ...
  if (inode.i_mode & IALLOC) {
    ...
    if (inode.i_mode & IFDIR) {
      ...
      if(inodeOpen >= 0) {
        ...
        //correcteur: utilisez getsectorsize  [M]
        //correcteur: Pas tout a fait juste la taille est trop grande si la
        // taille est SECTOR_SIZE de trop.
        ...
        //correcteur: EN effet il fallait le mettre. -1
        //data[inode_size] = '\0';
